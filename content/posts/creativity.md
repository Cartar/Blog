...
But who cares what I think, let's find out what science has to say. Specifically, let's review a review: [Research on Workplace Creativity (2000-2014)](https://www.annualreviews.org/doi/pdf/10.1146/annurev-orgpsych-031413-091226). And besides learning what the research shows, we'll learn how to shape your environment for the better.
...
Unfortunately, the review didn't really touch on that research because, well, how to *suppress* creativity isn't well studied. I guess there isn't much money in it? Go figure :shrug: However, there is one study mentioned. It showed knowledge hiding decreases an individual's creativity. 
...
These minor changes, ever so small, had real dividends. Before Sir Dave Brailsford, Great Britain had never won the Tour De France. With him at the helm, they've won [6 of the last 10 titles](https://en.wikipedia.org/wiki/List_of_Tour_de_France_general_classification_winners).
...
Note: much of this section was taken from a podcast interview from Sam Harris and James Clear. You should really [listen to James](https://samharris.org/podcasts/200-creatures-habit/) speak about this topic, he's the expert.

## Beyond the workplace
Environment engineering isn't for the workplace alone. It's a very powerful tool for self improvement too. As outlined by James,
...
If you're new to mindfulness as a tool for stress management, I suggest trying the [Waking Up meditation app](https://dynamic.wakingup.com/redeemMonth/ff5831). If you're unsure what breathing exercises to do, review Andrew Huberman's work.
<br />
{{< youtube 9KmH7roj-dg >}}
<br />
